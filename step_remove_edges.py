...
if __name__ == "__main__":
	...
	parser.add_argument("--original_graph",default= "dataset/demo.edges", help = "input directed graph (with cycles) (format can be *.gpickle, *.edges)")
	parser.add_argument("--deleted_edges",default= "dataset/demo_deleted_edges.edges", help = "edges to be deleted to reduce a directed graph to a DAG (format can be *.edges/txt)")
